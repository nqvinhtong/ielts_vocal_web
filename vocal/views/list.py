...
SEARCH_VOCAL_URL = "/ielts-vocal/searchs/vocals"
IELTS_VOCAL_ENDPOINT_HOST = "http://localhost:8080"
API_VERSION = "1.0"


class VocalListView(TemplateView):
    template_name = 'vocal/list_vocal.html'
    logger = logger
    response = {}

    def dispatch(self, request, *args, **kwargs):
        return super(VocalListView, self).dispatch(request, *args, **kwargs)
